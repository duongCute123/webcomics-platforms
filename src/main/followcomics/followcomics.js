            ...
            <div className="my-2">
                ...
                </h1>
                {
                    user?.uid ?
                        ...
                        :
                        <h1 className="font-bold text-xl md:text-2xl lg:text-3xl mx-3 justify-center flex flex-col">Vui lòng đăng nhập để xem danh sách truyện bạn đã theo dõi. <Link className="text-center my-10 text-blue-500" to={"/user/login"}>Đăng Nhập</Link></h1>
                }
            </div>
        </div>
    )
