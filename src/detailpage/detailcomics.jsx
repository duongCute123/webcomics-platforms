...
const DetailPage = () => {
    ...
    const getChapter = (chapterstart, chapterend) => {
        ...
        const chapters = [...detaicomicse.detailcomics.chapters]
            .reverse()
    ...
    useEffect(() => {
        for (const idx in new Array(totalChapter)) {
            if (idx + 1 < totalChapter) {
                setIsChapter(idx === 0 ? 0 : idx * chapterPerPage + 1 - (idx + 1) * chapterPerPage)
            }
            else {
                setIsChapter(totalChapter === 1 ? 0 : idx * chapterPerPage + 1 - newChapter)
            }
        }
    }, [])
        ...
        <div className="relative w-full">
            ...
            <div className="inset-x-0 top-0 h-80 bg-gradient-to-b  from-emerald-100 -z-10 w-full absolute">
                ...
                <div className="max-w-5xl mx-auto justify-center my-5">
                    ...
                    <div className="">
                        <button type="button">{IsChapter}</button>
                    </div>
